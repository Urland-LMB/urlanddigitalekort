...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [774033.793773, 6958545.018850, 2147658.021335, 7896341.497038], maxZoom: 12, minZoom: 7
    })
});
...
map.getView().fit([774033.793773, 6958545.018850, 2147658.021335, 7896341.497038], map.getSize());
