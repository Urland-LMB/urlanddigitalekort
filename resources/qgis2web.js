...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [733341.120472, 7204044.610601, 1844570.757253, 7951359.011401], maxZoom: 12, minZoom: 7
    })
});
...
map.getView().fit([733341.120472, 7204044.610601, 1844570.757253, 7951359.011401], map.getSize());
