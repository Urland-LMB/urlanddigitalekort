...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [683268.426350, 7148589.860433, 1893329.771345, 7959995.678174], maxZoom: 12, minZoom: 7
    })
});
...
map.getView().fit([683268.426350, 7148589.860433, 1893329.771345, 7959995.678174], map.getSize());
