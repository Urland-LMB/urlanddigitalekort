...
var format_Bypolygoner_8 = new ol.format.GeoJSON();
var features_Bypolygoner_8 = format_Bypolygoner_8.readFeatures(json_Bypolygoner_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Bypolygoner_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Bypolygoner_8.addFeatures(features_Bypolygoner_8);
var lyr_Bypolygoner_8 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Bypolygoner_8, 
                style: style_Bypolygoner_8,
                interactive: true,
                title: '<img src="styles/legend/Bypolygoner_8.png" /> Bypolygoner'
            });
...
lyr_19951998A_0.setVisible(true);lyr_19992002A_1.setVisible(true);lyr_20032006A_2.setVisible(true);lyr_20072010A_3.setVisible(true);lyr_20112014A_4.setVisible(true);lyr_20152018A_5.setVisible(true);lyr_DanmarkOutline_6.setVisible(true);lyr_Kommunegrnser_7.setVisible(true);lyr_Bypolygoner_8.setVisible(true);
var layersList = [group_Boligpriskortcropped,lyr_DanmarkOutline_6,lyr_Kommunegrnser_7,lyr_Bypolygoner_8];
...
lyr_Bypolygoner_8.set('fieldAliases', {'FOT_ID': 'FOT_ID', 'MOB_ID': 'MOB_ID', 'FEAT_KODE': 'FEAT_KODE', 'FEAT_TYPE': 'FEAT_TYPE', 'FEATSTATUS': 'FEATSTATUS', 'GEOMSTATUS': 'GEOMSTATUS', 'BYTYPE': 'BYTYPE', 'BEBYG_KODE': 'BEBYG_KODE', 'TIMEOF_CRE': 'TIMEOF_CRE', 'TIMEOF_PUB': 'TIMEOF_PUB', 'TIMEOF_REV': 'TIMEOF_REV', 'TIMEOF_EXP': 'TIMEOF_EXP', 'Areas': 'Areas', 'Area': 'Area', 'Area2': 'Area2', });
...
lyr_Bypolygoner_8.set('fieldImages', {'FOT_ID': '', 'MOB_ID': '', 'FEAT_KODE': '', 'FEAT_TYPE': '', 'FEATSTATUS': '', 'GEOMSTATUS': '', 'BYTYPE': '', 'BEBYG_KODE': '', 'TIMEOF_CRE': '', 'TIMEOF_PUB': '', 'TIMEOF_REV': '', 'TIMEOF_EXP': '', 'Areas': '', 'Area': '', 'Area2': '', });
...
lyr_Bypolygoner_8.set('fieldLabels', {'FOT_ID': 'no label', 'MOB_ID': 'no label', 'FEAT_KODE': 'no label', 'FEAT_TYPE': 'no label', 'FEATSTATUS': 'no label', 'GEOMSTATUS': 'no label', 'BYTYPE': 'no label', 'BEBYG_KODE': 'no label', 'TIMEOF_CRE': 'no label', 'TIMEOF_PUB': 'no label', 'TIMEOF_REV': 'no label', 'TIMEOF_EXP': 'no label', 'Areas': 'no label', 'Area': 'no label', 'Area2': 'no label', });
lyr_Bypolygoner_8.on('precompose', function(evt) {
